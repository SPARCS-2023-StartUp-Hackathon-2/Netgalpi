                  ...
                  children: [
                    Padding(
                      ...
                      child: const Text(
                        '네컷 사진',
                        textAlign: TextAlign.left,
                        style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18, height: 3),
                      ),
                    ),
                  ],
                ),
                ...
                children: [
                  ...
                  Padding(
                            ...
                            child: TextButton(
                              onPressed: () {               
                                if(_image!=null){
                                var pid = FireStorage().uploadPostImg(_image!);
                                print("dfADFfd");
                                print(pid); 
                              }},
                              child: const Text(
                    ...
                    children: [
                      Padding(
                            ...
                            child: TextButton(
                              onPressed: () async { 
                                if(_image!=null){
                                  var pid = await FireStorage().uploadPostImg(_image!);
                                  controller.postImgMap[pid] = CachedNetworkImageProvider(image.path);
                                  Get.to(TagView());}},
                              child: Text(
                                '다음',
                                textAlign: TextAlign.right,
